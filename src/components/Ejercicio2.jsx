...
import PaginaMoviles from './PaginaMoviles';
      ...
      <div id="ej2">
        ...
        <ul>
          ...
          <li>
            ...
            Salvo la imagen, para recuperar el resto de elementos tenéis que
            llamar a la API (Phone Specifications) usando el campo <i>detail</i>{' '}
            o <i>slug</i>
